...
def any_collating():
    ...
    env.project = 'any_collating'
    #  hg repository of your project
    env.repository = 'git@github.com:CoinLQ/AnyCollating.git'
    ...
    env.django_media_url = '/site_media/any_collating/media/'
    env.django_media_root = env.code_root
    #  django static url and root dir
    env.django_static_url = '/site_media/any_collating/static/'
