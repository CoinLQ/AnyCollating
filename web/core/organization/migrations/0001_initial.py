    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(related_name='organization_children', verbose_name='\u4e0a\u7ea7\u516c\u53f8', blank=True, to='organization.Organization', null=True)),
            ],
            options={
                'verbose_name': '\u516c\u53f8',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(editable=False, db_index=True)),
                ('level', models.PositiveIntegerField(editable=False, db_index=True)),
                ('organization', models.ForeignKey(related_name='departments', default=None, blank=True, to='organization.Organization', null=True, verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe5\x85\xac\xe5\x8f\xb8')),
                ('creator', models.ForeignKey(verbose_name='\u6570\u636e\u521b\u5efa\u4eba', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
